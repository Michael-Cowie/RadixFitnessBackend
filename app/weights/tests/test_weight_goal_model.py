...
class WeightGoalModelTest(TestCase):
    ...
    def test_date_format(self):
        ...
        self.assertEqual("['“2024-not-a-date” value has an invalid date format. It must be in YYYY-MM-DD format.']",
                         str(e.exception))
    ...
    def test_weight_validator(self):
        ...
        self.assertEqual("[ValidationError(['Ensure this value is greater than or equal to 1.'])]",
